export const ContactForm = () => {
  return (
    <div className="rounded-lg bg-white text-[#101010] shadow-lg m-4 p-7 sm:m-6 sm:p-8 md:m-8 md:p-10 lg:m-12">
      ...
      <form className="mt-8 space-y-5 font-mono">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="w-full rounded-md bg-[#891AD5] px-10 py-3 text-[15px] font-bold tracking-wide text-white transition-colors hover:bg-blue-800 sm:w-auto"
          >
            Enviar Mensaje
          </button>
        </div>
